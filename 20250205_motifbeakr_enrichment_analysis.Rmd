...
This is the motifbreakR analysis for "Linking candidate causal autoimmune variants to T cell networks using genetic and epigenetic screens in primary human T cells" (Ho et al. 2025). 
...
5. Repeat step 3-4 with jurkat MPRA expression data

6. Run t-test analysis for variants fine-mapped to each disease (primary T-cell MPRA)

7. Merge the primary T-cell and unstimulated jurkat data
...
Set a seed because this analysis has stochastic elements (seed set on 1/29/25)
```{r}
set.seed(413) 
```
