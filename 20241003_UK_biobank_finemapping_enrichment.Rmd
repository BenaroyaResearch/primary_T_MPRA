...
mpra_biobank_merge_all_traits_plot <- read.table(paste0("/nfs/jray/screens/ALL_MPRAs/Ho_et_al_analysis/Downstream_Analysis/20240310_mpra_analysis/UK_biobank_finemapping_enrichment/data/","mpra_biobank_merge_all_traits",".txt"), header=T, stringsAsFactors = F, sep="\t")
